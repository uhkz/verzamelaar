...
<head>
  ...
  <script src="https://kit.fontawesome.com/779605ea5f.js" crossorigin="anonymous"></script>
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="../../index.php"><img class="logo" width="60" height="48" src="../../media/logo.png"
          alt=""></a>
  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col fs-4">
        <h3 class="fw-bold">Uitgelichte auto's</h3>
      </div>
    </div>
